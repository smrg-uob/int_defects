...
echo "int_defects_write_inp_parametric('paramRangeStruct_elastic_single.mat','IntCrackJob1_6.0.3_single_master.py','abaqus',600);" >> int_defects_write_inp_wrapper.m
echo "load('abaqus_param_files/workspace_dump.mat'); int_defects_run_parametric_parallel(paramLogStruct,filenamesStruct,'abaqus',3600,1,2,false,true);" >> int_defects_run_wrapper.m
